...
async function getStaticProps() {
    ...
    // Call the fetch method and passing
    // the pokeAPI link
    const response = await fetch("https://hubapi.gridgamers.com/api/v1/setting/privacypolicy-termscondition?SubCatagoryId=13");
    // Parse the JSON
    ...
    return {
        props: {
            TermConditions: data.response.subCategoryDescription
        }
    };
}
